...
import kata.impl.VolodimirD.FiveKataImpl;
...
public class Main {
	...
	private static void fiveKataHandler() {
		...
		if("2".equals(choice)) {
			...
			System.out.println("The result of execute of smallest method is: "
					+ new kata.impl.AnastasiaZadolinna.FiveKataImpl().smallest(value));
		}
	}
	...
	private static void sixthKataHandler() {
		...
		if ("1".equals(choice)) {
			...
			System.out.println(
					"The result of execute of BALANCE method is: \n" + new SixthKataImpl().balance(DATA_FOR_BALANCE));
	...
	private static void eightKataHandler() {
		...
		if ("1".equals(choice)) {
			...
			System.out.println(
					"The result of method execution is " + Arrays.toString(eightKata.squareOrSquareRoot(array)));
			...
			System.out.println("The result of method execution is "
					+ Arrays.toString(eightKata.countPositivesSumNegatives(array)));
		} else if ("3".equals(choice)) {
			...
			double val = scanner.nextDouble(); // val - number given double numbers
			System.out.println(
					"formated numbers that are rounded to to decimal places: " + eightKata.twoDecimalPlaces(val));
		} else if ("9".equals(choice)) {
			int arrayNumbLenth = ConsoleInput
					.intInput("Enter the values of Numbers and Divisors\n How many Numbers do you want to divide?");
			Scanner input = new Scanner(System.in);
